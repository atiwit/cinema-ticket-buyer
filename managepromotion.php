...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent1" aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
  <div class="collapse navbar-collapse" id="navbarSupportedContent1">
    ...
    <li class="nav-item active"> <a class="btn btn-outline-success" href="logout">Logout&nbsp; <span class="sr-only">(current)</span></a> </li>
        ...
        <h1><center>จัดการโปรโมชั่น</center></h1>
            <?php
                include('condb.php');
        ...
        <img class="card-img-top" style="border-radius: 16px; height:25rem;"src="<?php echo $row['pro_img'];?>" alt="Card image cap">
        <p><?php echo $row['pro_name'];?></p>
        <center>
        <a href="editpromotion?id=<?php echo $row['id'];?>" class="btn btn-outline-warning">แก้ไข</a> <a href="managepromotion?action=delete&id=<?php echo $row['id'];?>" class="btn btn-danger">ลบ</a>
        </center><br>
        </div>
        </div>
        <?php
